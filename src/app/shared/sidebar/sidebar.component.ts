...
export class SidebarComponent {
  ...
  public phoneNumber(value: any) {
      value.length > 10 
      ? (this.loginContainer = 'login-container-error',this.errorClass = "invalidErrorOccur",this.invalidNumber = true)
      : (this.loginContainer = 'login-container', this.errorClass = "invalidError", this.invalidNumber = false);
  }
